...
pkgs.stdenv.mkDerivation rec {
  ...
  src = pkgs.fetchFromGitHub {
    ...
    sha256 = "sha256-Nv/0a4FGJMS7x3ScC3AdBMhc6SIaw5GRYtBZAySTkok=";
    #sha256 = "sha256-cmhf9v5MhTnJCfhFAFVz29oTv1Rm0yB/u1bl4+juUbY=";
  ...
  pnpmDeps = pkgs.pnpm.fetchDeps {
    ...
    hash = "sha256-Fs+aQOu+/ZhjaSdoqRFk7n7GuhJ42b9qFwuqKtb7bHM=";
    #hash = "sha256-wf2bXUeIe7Jc7uo9pFfF4b/KVs/5Umloo3Cbk17dTkI=";
